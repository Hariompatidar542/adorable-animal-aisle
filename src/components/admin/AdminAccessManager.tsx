...
export const AdminAccessManager: React.FC = () => {
  ...
  const availableUsers = allUsers.filter(user => !adminUsers.some(admin => admin.user_id === user.id && admin.is_active));
  ...
  return <div className="space-y-6">
      <Card className="bg-slate-50">
        ...
        <CardContent className="space-y-4 bg-slate-50">
          <div className="flex gap-3">
            ...
            <Button onClick={handleGrantAdmin} disabled={!selectedUserId || isGranting} className="gradient-primary text-slate-900">
      ...
      <Card>
        ...
        <CardContent className="bg-slate-50">
          {activeAdmins.length === 0 ? <div className="text-center py-8 text-muted-foreground bg-slate-100">
            ...
            return <div key={admin.id} className="flex items-center justify-between p-3 border rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => handleRevokeAdmin(admin.user_id)} disabled={isRevoking} className="text-red-600 hover:text-red-700">
