...
export const OrderStatusTimeline: React.FC<OrderStatusTimelineProps> = ({
  ...
  return <div className="space-y-4">
      <h3 className="font-medium text-sm text-slate-900">Order Timeline</h3>
      <div className="relative">
        {statusSteps.map((step, index) => <div key={step.key} className="relative flex items-start space-x-3 pb-6 last:pb-0 bg-slate-200">
            {/* Connector line */}
