      ...
      <div className="container mx-auto px-4 max-w-6xl bg-slate-50">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="order-1 lg:order-2">
            <form onSubmit={handleSubmit} className="space-y-6 bg-slate-50">
              {/* Contact Information */}
              <Card className="bg-slate-200">
                <CardHeader className="bg-slate-200">
                ...
                <CardContent className="space-y-4 bg-slate-200">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="email" name="email" type="email" value={formData.email} onChange={handleInputChange} required className="bg-slate-50" />
                    </div>
                    <div>
                      <Label htmlFor="fullName">Full Name</Label>
                      <Input id="fullName" name="fullName" value={formData.fullName} onChange={handleInputChange} required className="bg-slate-50" />
                    </div>
                  </div>
                  <div>
                    <Label htmlFor="phone">Phone Number</Label>
                    <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleInputChange} required className="bg-slate-50" />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-200">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input id="address" name="address" value={formData.address} onChange={handleInputChange} required className="bg-slate-50" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="city">City</Label>
                      <Input id="city" name="city" value={formData.city} onChange={handleInputChange} required className="bg-slate-50" />
                    </div>
                    <div>
                      <Label htmlFor="postalCode">Postal Code</Label>
                      <Input id="postalCode" name="postalCode" value={formData.postalCode} onChange={handleInputChange} required className="bg-slate-50" />
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {/* Place Order Button */}
              <Button type="submit" size="lg" disabled={isCreating} className="w-full gradient-primary hover:opacity-90 text-stone-100 bg-slate-900 hover:bg-slate-800">
